...
# ══════════════════════════════════════════════════════════════════════
# HOSTING-SAFE INPUT VISIBILITY FIX
# Works on Streamlit Cloud / custom hosting / dark-mode browsers
# ══════════════════════════════════════════════════════════════════════
st.markdown("""
<style>
...
/* Sidebar dropdown selected text */
[data-testid="stSidebar"] div[data-baseweb="select"] span {
    color: #ffffff !important;
    -webkit-text-fill-color: #ffffff !important;
}

/* Prevent autofill yellow/hidden text issue */
